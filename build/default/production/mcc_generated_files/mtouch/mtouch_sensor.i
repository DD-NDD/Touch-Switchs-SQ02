...
# 247 "mcc_generated_files/mtouch/../pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 259 "mcc_generated_files/mtouch/../pin_manager.h"
...
# 52 "mcc_generated_files/mtouch/../mcc.h" 2
...
# 1 "mcc_generated_files/mtouch/../mtouch/mtouch.h" 1
# 41 "mcc_generated_files/mtouch/../mtouch/mtouch.h"
...
# 119 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_Initialize(void);
# 172 "mcc_generated_files/mtouch/../eusart.h"
uint8_t EUSART_is_tx_ready(void);
# 224 "mcc_generated_files/mtouch/../eusart.h"
uint8_t EUSART_is_rx_ready(void);
# 271 "mcc_generated_files/mtouch/../eusart.h"
_Bool EUSART_is_tx_done(void);
# 319 "mcc_generated_files/mtouch/../eusart.h"
eusart_status_t EUSART_get_last_status(void);
# 339 "mcc_generated_files/mtouch/../eusart.h"
uint8_t EUSART_Read(void);
# 359 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_Write(uint8_t txData);
# 380 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_Transmit_ISR(void);
# 401 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_Receive_ISR(void);
# 422 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_RxDataHandler(void);
# 440 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_SetFramingErrorHandler(void (* interruptHandler)(void));
# 458 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 476 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_SetErrorHandler(void (* interruptHandler)(void));
# 496 "mcc_generated_files/mtouch/../eusart.h"
void EUSART_SetTxInterruptHandler(void (* interruptHandler)(void));
# 516 "mcc_generated_files/mtouch/../eusart.h"
...
static __attribute__((inline)) _Bool Sensor_isActive (mtouch_sensor_t* sensor);

static _Bool Sensor_isEnabled (mtouch_sensor_t* sensor);

static __attribute__((inline)) _Bool Sensor_isCalibrated (mtouch_sensor_t* sensor);
static __attribute__((inline)) void Sensor_setCalibrated (mtouch_sensor_t* sensor);
static __attribute__((inline)) void Sensor_setCalibratAcqTime (mtouch_sensor_t* sensor);
static __attribute__((inline)) _Bool Sensor_isCalibratingAcqTime (mtouch_sensor_t* sensor);
...
static mtouch_sensor_sampleperiod_t sample_period = ((mtouch_sensor_sampleperiod_t)(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)110);
...
static mtouch_scan_group_t const sensor_scan_group[1u] = {
    { &(mtouch_sensor[Sensor_AN13]),&(mtouch_sensor[Sensor_AN26])},
};
...
# 249 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    uint8_t group;
    for (group = 0; group < 1u; group++)
    {
...
{
    uint8_t sensorGroup;
    for(sensorGroup = 0; sensorGroup < 1u; sensorGroup++)
    {
...
static enum mtouch_sensor_error Sensor_Acquisition(mtouch_sensor_t* sensor_adc1,mtouch_sensor_t* sensor_adc2)
{
    ...
    if (sensor_adc1 == ((void*)0) && sensor_adc2 == ((void*)0))
    {
    ...
    if(sensor_adc1 != ((void*)0))
    {
        Sensor_postAcquisitionProcess(sensor_adc1);
    }

    if(sensor_adc2 !=((void*)0))
    {
...
static void Sensor_loadADCSettings(mtouch_sensor_t* sensor, uint8_t adc_index)
{
    ...
    *(&AAD1GRD + addressOffset) &= (uint8_t) 0b11111110;
    ...
    {
        *(&AD1PRECON + addressOffset) = (mtouch_sensor_time_t)32;
        if (Sensor_isCalibratingAcqTime(sensor))
            *(&AD1ACQCON + addressOffset) = (uint8_t) sensor->acquisition_time;
        else
            *(&AD1ACQCON + addressOffset) = (mtouch_sensor_time_t)32;
    }

    packet_sample[adc_index] = ((mtouch_sensor_packetsample_t)(sensor->oversampling)<<9);
}
...
static enum mtouch_sensor_error Sensor_Acq_ExecutePacket(mtouch_sensor_t* sensor_adc1,mtouch_sensor_t* sensor_adc2)
{
    ...
    if(sensor_adc1 != ((void*)0) && sensor_adc2 != ((void*)0))
    {
        if (sensor_adc1->enabled == 0 && sensor_adc2->enabled == 1)
        {
            sensor_adc1->enabled = 1;
            sensor1ForceEnabled = 1;
        }
        else if (sensor_adc2->enabled == 0 && sensor_adc1->enabled == 1)
        {
            sensor_adc2->enabled = 1;
            sensor2ForceEnabled = 1;
        }
        else if(sensor_adc1->enabled == 0 && sensor_adc2->enabled == 0)
        {
            return MTOUCH_SENSOR_ERROR_none;
        }
        else {
    ...
    else if(sensor_adc1 == ((void*)0) && sensor_adc2 != ((void*)0))
    {
        if(sensor_adc2->enabled == 0)
        {
            return MTOUCH_SENSOR_ERROR_none;
        }
        else {
...
# 679 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_autoCalibration(mtouch_sensor_t* sensor)
{
    uint8_t adcIndex = Sensor_getScanGroupIndex(sensor);
    ...
    if(!Sensor_isCalibratingAcqTime(sensor))
    {
        if(packet_sample[adcIndex] > ((mtouch_sensor_packetsample_t)(sensor->oversampling)<<9))
        {
            if(++(sensor->addcap) >= (uint8_t)0x0F)
    ...
    {
        if((mtouch_sensor_packetsample_t)abs(packet_sample[adcIndex] - sensor->rawSample) < ((mtouch_sensor_packetsample_t)(sensor->oversampling)<<1))
        {
            sensor->precharge_time = (mtouch_sensor_time_t)32;
        ...
        else
        {
            ...
            if((sensor->acquisition_time)>=(mtouch_sensor_time_t)32)
            {
                sensor->precharge_time = (mtouch_sensor_time_t)32;
                Sensor_setCalibrated(sensor);
            }
...
# 724 "mcc_generated_files/mtouch/mtouch_sensor.c"
static enum mtouch_sensor_error Sensor_Scanfrequency_Evaluation(mtouch_sensor_t* sensor_adc1,mtouch_sensor_t* sensor_adc2)
{
    uint8_t i;
    ...
    packet_noise_Max = packet_noise + (packet_noise>>2);
    ...
    for(i=(uint8_t)0;i<(uint8_t)5;i++)
    {
        ...
        if(sample_period > ((mtouch_sensor_sampleperiod_t)255))
        {
            sample_period-=((mtouch_sensor_sampleperiod_t)255);
            sample_period+=((mtouch_sensor_sampleperiod_t)(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)110);
        }
        else if(sample_period < ((mtouch_sensor_sampleperiod_t)(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)110))
        {
            sample_period += ((mtouch_sensor_sampleperiod_t)(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)32 +(mtouch_sensor_time_t)110);
        }
...
# 863 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 895 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Calibrate(enum mtouch_sensor_names sensor)
{
    if(sensor < 2u)
    {
...
{
    if(sensor < 2u)
        return (_Bool)mtouch_sensor[sensor].calibrated;
    else
        return 0;
}
...
static __attribute__((inline)) _Bool Sensor_isCalibrated(mtouch_sensor_t* sensor)
{
    return (_Bool)sensor->calibrated;
}
...
static __attribute__((inline)) void Sensor_setCalibratAcqTime(mtouch_sensor_t* sensor)
{
    ...
    sensor->acquisition_time = (mtouch_sensor_time_t)1;
}

static __attribute__((inline)) _Bool Sensor_isCalibratingAcqTime(mtouch_sensor_t* sensor)
{
    return (_Bool)sensor->acqTime_cal;

}
# 941 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
...
# 972 "mcc_generated_files/mtouch/mtouch_sensor.c"
uint8_t MTOUCH_Sensor_AdditionalCap_Get(enum mtouch_sensor_names name)
{
     if(name < 2u)
        return (uint8_t)(mtouch_sensor[name].addcap<<1);
     else
        return 0;
}
