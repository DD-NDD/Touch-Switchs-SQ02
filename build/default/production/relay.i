...
void RELAY_PROCESS(uint8_t x)
{
    switch(x)
    {
        case 0:
        {
            do { LATAbits.LATA5 = 1; } while(0);do { LATAbits.LATA4 = 1; } while(0);
            break;
        }
        case 1:
        {
            do { LATAbits.LATA5 = 1; } while(0);do { LATAbits.LATA4 = 0; } while(0);
            break;
        }
        case 2:
        {
            do { LATAbits.LATA5 = 0; } while(0);do { LATAbits.LATA4 = 1; } while(0);
            break;
        }
        case 3:
        {
            do { LATAbits.LATA5 = 0; } while(0);do { LATAbits.LATA4 = 0; } while(0);
            break;
        }
    }
}
